...
class ABRExpert:
    ...
    def __init__(self, abr_env, rebuffer_penalty, smooth_penalty, \
                    mpc_horizon = MPC_FUTURE_CHUNK_COUNT, total_chunk_num = 271, \
                        bitrate_version = [135, 340, 835, 1350, 2640]):
        self.env = abr_env
        ...
        for combo in itertools.product([0,1,2,3,4], repeat=mpc_horizon):
