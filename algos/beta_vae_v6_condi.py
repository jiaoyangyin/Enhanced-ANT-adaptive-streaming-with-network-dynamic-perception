...
class BetaVAE(torch.nn.Module):
    def __init__(self,
        ...
        in_channels_ = (self.hist_dim - 3) * self.FE_cnn_channels + (self.hist_dim - 3 - 35) * self.FE_cnn_channels
    ...
    def encode(self, input):
        ...
        # print(FE_cnn_1.shape)
        FE_cnn_1_ = FE_cnn_1.view(-1, self.num_flat_features(FE_cnn_1))
        # print(FE_cnn_1_.shape)

        FE_cnn_2 = self.FeatureExactor_CNN(fut_inputs_2_)
        # print(FE_cnn_2.shape)
        FE_cnn_2_ = FE_cnn_2.view(-1, FE_cnn_2.shape[1] * FE_cnn_2.shape[2])
        # print(FE_cnn_2_.shape)
